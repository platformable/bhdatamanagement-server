...
try {
  const getData = axios({
    ...
    data: {
      ...
      force_async: false,
      paths: [
        `/Data Governance App/Events/${programName}/${eventName.replace("/","-")}-${eventDate}/Documents`,
        `/Data Governance App/Events/${programName}/${eventName.replace("/","-")}-${eventDate}/Images`
      ],
    },
  });
  ...
  try {
      const getData = axios({
          ...
          data: {
              ...
              "path": `/Data Governance App/Events/${programName}/${eventName.replace("/","-")}-${eventDate}`,
  ...
  try {
      const getData = axios({
          ...
          data: {
              ...
              "force_async": false,
              "member_policy": "anyone",
              "path": `/Data Governance App/Events/${programName}/${eventName.replace("/","-")}-${eventDate}/${folder}`,
              "shared_link_policy": "anyone"
          }
      })
